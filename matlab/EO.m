...
function [Convergence_curve,Ave,Sd, Best_pos]=EO(Particles_no,Max_iter,lb,ub,dim,fobj,Run_no, xlearn, zlearn, xtest, ztest, labellearn, labeltest)
...
while Iter<Max_iter
      ...
      for i=1:size(C,1)  
        ...
        fitness(i)=fobj(C(i,:), xlearn, zlearn, xtest, ztest, labellearn, labeltest);  
